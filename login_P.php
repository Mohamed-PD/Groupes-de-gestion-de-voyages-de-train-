...
$_SESSION['username'] = $number;
        ...
        $sql = "SELECT * FROM passagers WHERE passager_id  = '$number' AND mdp = '$mdp'";
...
<br>
                ...
                <button type="submit" class="btnn"><a href="paiement.php">Se Connecter</button></a>
                <button type="reset" class="btnn"><a href="#">Annuler</a></button>
                <button type="" class="btnn"><a href="paiement.php">Revenir</button></a></div>
</form>
