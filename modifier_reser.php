...
<body>
    <form action="modifier_re.php" method="post">
        ...
        <input type="number" id="id" name="reservation_id" maxlength="100" placeholder="" required>

       
<!-- Champ passager ID -->
<label for="passager_id">passager_id</label>
...
?>
        ...
        <label for="num_place">Numero de place</label>
        <input type="number" id="num_place" name="num_place" required>

        <!-- Champ Date -->
        <label for="date_reservation">Date de reservation</label>
        <input type="datetime-local" id="date_reservation" name="date_reservation" required>
