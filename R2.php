...
$sql = ("INSERT INTO reservation VALUES (NULL, '$c', $d, NULL,'$a',$b)");

$B= "SELECT id_vols, A1.nom_aeroport, A2.nom_aeroport, Date_depart, Heure_depart, Date_arrive, Heure_arrive, prix_billet 
